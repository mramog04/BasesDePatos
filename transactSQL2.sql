...
CREATE TABLE ROUTES (
    ...
    ROUTENAME VARCHAR(100) NOT NULL,
    ESTIMATEDLENGTHTIME INT NOT NULL DEFAULT 60 CHECK (ESTIMATEDLENGTHTIME >= 15 AND ESTIMATEDLENGTHTIME <= 90),
    STARTHOUR TIME NOT NULL CHECK (STARTHOUR >= '10:00' AND STARTHOUR <= '18:00'),
    SECTIONID INT,
    CONSTRAINT FK_ROUTESSECTION FOREIGN KEY (SECTIONID) REFERENCES SECTIONS(SECTIONID)
);
...
ALTER TABLE SHOPS ADD CONSTRAINT FK_SHOPSECTION FOREIGN KEY (SECTIONID) REFERENCES SECTIONS(SECTIONID) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE WEAPON ADD CONSTRAINT FK_WEAPONWEAPONLICENCE FOREIGN KEY (WEAPONLICENCESID) REFERENCES WEAPONLICENCES(WEAPONLICENCEID);
...
ALTER TABLE SECCLEA ADD CONSTRAINT FK_EMPLOYEESECCLEA FOREIGN KEY (EMPLOYEEID) REFERENCES STRUCTURALEMPLOYEES(EMPLOYEEID);
